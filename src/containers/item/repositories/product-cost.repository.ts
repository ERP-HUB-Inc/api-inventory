...
export default class ProductCostRepository extends BaseRepository<ProductCost> {
    ...
    async findMany(filter: Filter): Promise<[ProductCost[], number]> {
        ...
        return await this.findManyQueryBuilder(ProductCost, [{
