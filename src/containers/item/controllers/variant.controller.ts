...
import { toAdvanceFilterArr, AdvanceFilter } from "../../../core/common/filters";
...
export default class ProductVariantController extends BaseController {
    ...
    getByAttributeValue(
        ...
        return this.service.findOne({ productAttributeValueId }, null, ["productLocations"]);
    }
    ...
    async checkIsAvailableForArchive(
        ...
        return response.send({ status: await this.service.checkDeleteAvailability(id) });
    }
    ...
    checkIsAvailableArchiveAttributeValue(
        ...
        return this.service.checkIsAvailableForArchiveAttributeValue(attributeValueId);
    }
