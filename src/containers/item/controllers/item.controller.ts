...
export default class ItemController extends BaseController {
  ...
  getPromotion(
    ...
    return this.promotionRepository.getPromotion(
      user.clientId,
      variantId,
      orderQuantity,
      orderAmount,
  ...
  @Get('/get_form_data')
  getFormData(@CurrentUser() user: User) {
  ...
  getPurchaseHistory(
    ...
    return this.service.getPurchaseByProduct(
      user.clientId,
      productId,
      startDate,
      endDate,
  ...
  @Get('/attribute/all')
  getAttributes(@CurrentUser() user: User) {
    const filter = {
      limit: 'all',
      sortField: 'createdAt',
      sortOrder: 'ASC',
  ...
  @Get('attributes/:id')
  getAttributesById(@Param('id') id: string, @CurrentUser() user: User) {
    const option = {
  ...
  @Get()
  findAll(@CurrentUser() user: User, @QueryParams() query: PaginationQuery) {
    const option = {
      limit: query.limit,
      offset: query.offset,
  ...
  async splitProduct(
    ...
    return this.service.splitProduct(
      productVariantId,
      quantityToSplit,
      user.clientId,
      locationId,
  ...
  changeStatusVariant(@CurrentUser() user: User, @Param('id') id: string) {
  ...
  archiveVariant(@CurrentUser() user: User, @Param('id') id: string) {
