...
@Controller("/inventory/product/cost")
export default class ProductCostController extends BaseController {
    constructor(private service: ProductCostService) {
        super();
    }
    ...
    async create(
        @CurrentUser() user: User,
        @Body({ validate: true }) data: ProductCost
    ) {
